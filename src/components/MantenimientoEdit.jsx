...
const MantenimientoEdit = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`https://startupvje.vje.x10.mx/mant/mantenimiento/${id_mantenimiento}`)
            .then(response => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`https://startupvje.vje.x10.mx/mant/actualizarmantenimiento/${id_mantenimiento}`, mantenimiento)
            .then(response => {
